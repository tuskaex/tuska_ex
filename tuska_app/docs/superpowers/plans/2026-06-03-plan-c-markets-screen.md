...
**Goal:** Replace the Markets placeholder with the real Vantage-style screen — Watchlist | Explore toggle, category filter, Spotlight, Market Movers, Essentials list — wired to live Swisscresta data, plus InstrumentDetail and WatchlistEdit screens.
