...
**Goal:** Replace the Home placeholder screen with the real Vantage-style dashboard, wired to the live Swisscresta backend.
...
**Working directory:** `/Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk`
...
const KEY = 'swisscresta.watchlist';
...
const KEY = 'swisscresta.balanceHidden';
...
Verify with grep:
```bash
grep -n "getBars" /Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk/src/services/ApiService.js
```

- [ ] **Step 5: Smoke verify**

```bash
node -e "console.log(typeof require('/Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk/src/utils/watchlistStorage.js'))"
```

May fail because the file uses ESM `import`. That's fine — Metro/Babel handles it. Instead just `ls` the files:

```bash
ls /Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk/src/utils/watchlistStorage.js /Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk/src/utils/hiddenBalance.js /Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk/src/utils/sparklineCache.js
```
...
```bash
grep -n "from '../../components/vantage'" /Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk/src/screens/home/HomeHeader.js
```
...
```bash
grep -nE "from '\.\./(components/vantage|theme/vantageTheme|services|utils|context)" /Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk/src/screens/HomeScreen.js
```
...
```bash
cd /Users/tarundewangan/Downloads/Projects/Swisscresta/Swisscresta_apk && npx expo start
```
