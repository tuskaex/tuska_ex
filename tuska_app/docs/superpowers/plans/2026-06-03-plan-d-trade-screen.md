...
**Goal:** Replace the Trade placeholder with the Vantage CFDs + Copy split screen, wired to live Swisscresta backend. Functional order placement, live positions, leaderboards, and a strategy detail page.
