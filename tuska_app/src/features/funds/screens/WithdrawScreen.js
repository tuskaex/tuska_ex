...
export default function WithdrawScreen() {
  ...
  // Live accounts only, matching the web wallet. Checked here rather than at
  // submit so a demo user is not walked through a form that cannot succeed.
  ...
  if (user?.is_demo) {
    return (
      <Screen edges={['top']}>
        ...
        <DemoFundingGate feature="Withdrawals" />
      </Screen>
    );
  }
  return (
