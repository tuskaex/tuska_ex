...
export default function TransferScreen() {
  ...
  // Live accounts only, matching the web wallet. The account picker already
  // filtered demo accounts out of the list, which left a demo user staring at
  ...
  if (user?.is_demo) {
    return (
      <Screen edges={['top']}>
        ...
        <DemoFundingGate feature="Transfers" />
      </Screen>
    );
  }
