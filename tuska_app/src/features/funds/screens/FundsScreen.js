    ...
    <Screen edges={['top']} glow>
      ...
      <View style={styles.fixedHeader}>
        ...
        <View style={styles.tilesRow}>
          <QuickActionTile variant="flat" icon={<Ionicons name="arrow-up-outline" size={30} color={vantage.accent} />} label="Deposit" onPress={() => nav.navigate('Deposit')} />
          <QuickActionTile variant="flat" icon={<Ionicons name="arrow-down-outline" size={30} color={vantage.accent} />} label="Withdraw" onPress={() => nav.navigate('Withdraw')} />
          <QuickActionTile variant="flat" icon={<Ionicons name="swap-horizontal-outline" size={30} color={vantage.accent} />} label="Transfer" onPress={() => nav.navigate('Transfer')} />
          <QuickActionTile variant="flat" icon={<Ionicons name="receipt-outline" size={30} color={vantage.accent} />} label="History" onPress={() => nav.navigate('TransactionHistory')} />
        </View>
      </View>
