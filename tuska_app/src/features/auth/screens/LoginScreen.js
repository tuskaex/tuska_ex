...
// Screen-local palette — reference look: pure black canvas + #1B4DFF accent.
const THEME = '#1B4DFF';
const C = {
  bg:        '#000000',
  inputBg:   '#31302E',
    ...
    <View pointerEvents="none" style={styles.bg}>
      ...
      >
        <Svg width={BLOOM_D} height={BLOOM_D}>
          <Defs>
            {/* Brand bloom, fully faded to transparent before the edge */}
            <RadialGradient id="bgBloom" cx="50%" cy="50%" r="50%">
              <Stop offset="0" stopColor="#5C82FF" stopOpacity="0.95" />
              <Stop offset="0.18" stopColor={THEME} stopOpacity="0.85" />
              <Stop offset="0.42" stopColor="#0B2ECC" stopOpacity="0.38" />
              <Stop offset="0.7" stopColor="#061640" stopOpacity="0.12" />
              ...
              <Svg style={StyleSheet.absoluteFill} width="100%" height="100%">
                <Defs>
                  <SvgLinearGradient id="loginGrad" x1="0" y1="0" x2="1" y2="1">
                    ...
                    <Stop offset="1" stopColor="#0B2ECC" />
                  </SvgLinearGradient>
                </Defs>
...
const styles = StyleSheet.create({
  ...
  logo: { width: 200, height: 36, marginBottom: space.lg },
