...
export default function InstrumentDetailScreen() {
  ...
  // A resolution string the bars endpoint understands ('1' | '5' | '15' |
  // '30' | '60' | '240' | 'D'). The chart renders the picker; this screen
  // just holds the choice so it survives a fullscreen toggle.
        ...
        <View style={[styles.chartWrap, { height: chartH }]}>
              ...
              {!chartFull ? (
                <NativeChart
                  ...
                  accountId={activeAccount?.id || activeAccount?._id}
