...
const SupportScreen = ({ navigation }) => {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'OPEN': return '#1B4DFF';
      case 'IN_PROGRESS': return '#1B4DFF';
      case 'RESOLVED': return '#1B4DFF';
  ...
  const getPriorityColor = (priority) => {
    switch (priority) {
      case 'HIGH': return '#1B4DFF';
      case 'MEDIUM': return '#1B4DFF';
      case 'LOW': return '#1B4DFF';
      default: return '#666';
    }
  };
...
const styles = StyleSheet.create({
  ...
  createBtn: { backgroundColor: '#1B4DFF', paddingHorizontal: 24, paddingVertical: 12, borderRadius: 12, marginTop: 24 },
  ...
  priorityOptionActive: { backgroundColor: '#1B4DFF' },
  priorityOptionText: { color: '#666', fontSize: 14, fontWeight: '500' },
  priorityOptionTextActive: { color: '#000' },
  
  submitBtn: { backgroundColor: '#1B4DFF', padding: 16, borderRadius: 12, alignItems: 'center', marginTop: 24 },
  ...
  adminMessage: { backgroundColor: '#1B4DFF20', marginRight: 40 },
  messageHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 4 },
  messageSender: { color: '#1B4DFF', fontSize: 12, fontWeight: '600' },
  ...
  sendBtn: { backgroundColor: '#1B4DFF', width: 44, height: 44, borderRadius: 22, justifyContent: 'center', alignItems: 'center' },
});
