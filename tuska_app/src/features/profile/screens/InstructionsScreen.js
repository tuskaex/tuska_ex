      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.welcomeBanner, { borderColor: colors.accent + '30' }]}>
          ...
          <View style={styles.welcomeText}>
            <Text style={[styles.welcomeTitle, { color: colors.textPrimary }]}>Welcome to {brand.name}</Text>
...
const styles = StyleSheet.create({
  ...
  welcomeBanner: { 
    ...
    padding: 16, 
    borderRadius: 16, 
    backgroundColor: '#1B4DFF15',
    borderWidth: 1,
    borderColor: '#1B4DFF30'
  },
  welcomeIcon: { 
    width: 50, 
    height: 50, 
  ...
  contentNumberText: { color: '#1B4DFF', fontSize: 12, fontWeight: 'bold' },
  contentText: { flex: 1 },
