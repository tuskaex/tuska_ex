...
function LessonBlock({ block, colors }) {
  ...
  if (t === 'keyConcept') {
    return (
      <View style={[s.calloutBox, { backgroundColor: '#1B4DFF15', borderLeftColor: '#1B4DFF' }]}>
        <Text style={[s.calloutLabel, { color: '#1B4DFF' }]}>KEY CONCEPT</Text>
  ...
  return (
    <View>
      ...
      {data.keyTakeaways?.length > 0 && (
        <View style={[s.takeawaysBox, { backgroundColor: '#1B4DFF10', borderColor: '#1B4DFF' }]}>
          <Text style={[s.takeawaysHead, { color: '#1B4DFF' }]}>KEY TAKEAWAYS</Text>
