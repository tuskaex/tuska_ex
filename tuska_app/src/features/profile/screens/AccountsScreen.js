      ...
      >
        ...
        {mainTradingAccounts.length === 0 ? (
          ...
          mainTradingAccounts.map((account) => {
            ...
            // Live accounts carry the brand blue; demo accounts a muted slate.
            // This used to be `colors.warning` — amber — which tinted the whole
            // demo card header orange and also read as a warning state, which a
            // demo account is not. Muted vs branded says "practice vs real"
            // without borrowing an alert colour.
            const dotColor = isDemo ? colors.textSecondary : colors.accent;
