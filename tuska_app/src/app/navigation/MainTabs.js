...
import { brand, brandAssets } from '../../theme/brand';
...
// Light theme uses the brand-coloured mark; dark theme uses the white cut-out.
const HOME_ICON = LIGHT_THEME ? brandAssets.markOnLight : brandAssets.markOnDark;

// Each theme has its own Lottie set — the *-active variants are the brand-red
// (#1B4DFF) icons used on the light theme.
...
const TOUR_STEPS = [
  { key: 'welcome',  icon: 'information-circle-outline', tab: null, title: `Welcome to ${brand.name}`,
