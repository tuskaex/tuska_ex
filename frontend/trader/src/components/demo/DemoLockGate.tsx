...
export default function DemoLockGate({ feature, description, children }: Props) {
  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center p-4 sm:p-8">
      ...
      >
        <div className="mx-auto w-14 h-14 rounded-full bg-[#D60101]/15 border border-[#D60101]/30 flex items-center justify-center mb-4">
          <Lock className="w-6 h-6 text-[#D60101]" strokeWidth={2.2} />
        </div>
        ...
        <div className="mt-5 flex flex-col sm:flex-row gap-2 justify-center">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-[#D60101] text-white text-sm font-bold hover:bg-[#A30000] transition-colors shadow-[0_2px_8px_rgba(214,1,1,0.25)]"
          >
