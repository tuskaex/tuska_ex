...
// ============================================
// TUSKAEX - About Section — Cyber-Samurai
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <AnimatedSection animation="slideRight" delay={0.2}>
            ...
            <h2
              ...
              style={{ fontFamily: "var(--font-michroma), Michroma, sans-serif", textTransform: 'uppercase', letterSpacing: '0.03em' }}
            >
              Built on{' '}
              <span
                style={{
            ...
            <div className="space-y-4 mb-8">
              <p className="text-slate-400 leading-relaxed">
                TuskaEx is built on the foundation of transparency, innovation, and performance. Our mission is to bridge the gap between institutional trading technology and retail traders by delivering powerful tools, fair pricing, and secure infrastructure.
              </p>
              <p className="text-slate-400 leading-relaxed">
