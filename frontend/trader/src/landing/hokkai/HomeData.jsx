...
export const platforms = [
  { icon: <FiMonitor size={22}/>, name: 'TuskaEx WebTrader', tag: 'Browser-Based', desc: 'A browser-based trading platform that requires no downloads. Access markets instantly from any device with full charting functionality and advanced order types.', color: 'text-red-accent', bg: 'bg-red-accent/10', border: 'border-red-accent/20' },
...
export const testimonials = [
  { quote: "TuskaEx provides one of the fastest executions I've experienced. The platform is clean and the spreads are consistently tight.", author: 'Michael R.', role: 'Professional Forex Trader', rating: 5 },
  { quote: "Clean platform, tight spreads, and reliable support. I've been trading with TuskaEx for over a year and the experience has been excellent.", author: 'Sarah K.', role: 'Active Forex Trader', rating: 5 },
...
export const faqs = [
  ...
  { q: 'What trading platforms are available?', a: 'We offer TuskaEx WebTrader (browser-based), a Mobile App (iOS & Android), and a Desktop Terminal for professional traders.' },
