...
// TradingViewNewsTimeline.tsx). There is no TuskaEx news endpoint to call —
...
//     terminal talks only to the TuskaEx API, so this is the one panel that can
...
private:
    ...
    // TuskaEx ticker -> TradingView's exchange-qualified symbol.
