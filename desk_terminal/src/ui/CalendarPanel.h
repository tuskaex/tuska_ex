...
//
// Built the same way NewsPanel is, and for the same reason: the TuskaEx
...
//     talks only to the TuskaEx API, so this tab can be blank on a network that
...
private:
    ...
    // TuskaEx ticker -> the economies behind it. "EURUSD" -> "eu,us".
