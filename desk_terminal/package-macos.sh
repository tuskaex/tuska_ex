#!/usr/bin/env bash
# Package the built .app into dist/TuskaExTerminal-<version>-<arch>.dmg —
...
dmg="$dist/TuskaExTerminal-$version-$arch.dmg"
...
# notarised — with "TuskaEx Terminal is damaged and can't be opened", which
...
!!  This dmg is AD-HOC SIGNED, not notarised.
    ...
    a) For testers — they run this once after copying it to Applications:
           xattr -dr com.apple.quarantine "/Applications/TuskaEx Terminal.app"
